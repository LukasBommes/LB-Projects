...
function optionsframework_fields() {
	...
	foreach ( $options as $value ) {
		...
		// If the option is already saved, overide $val
		if ( ( $value['type'] != 'heading' ) && ( $value['type'] != 'info') ) {
		...
		case 'slider':
			...
			// Slider Title
			$output .= '<label class="explain" for="' . esc_attr( $value['id'] . '_title' ) . '">' . __('Title', 'lbprojects') . '</label>';
			$output .= '<input id="' . esc_attr( $value['id'] ) . '_title' . '" class="of-input" name="' . esc_attr( $option_name . '[' . $value['id'] . '][title]' ) . '" type="text" value="' . esc_attr( $val['title'] ) . '" />';			
			
			// Slider Link
			$output .= '<label class="explain" for="' . esc_attr( $value['id'] . '_link' ) . '">' . __('Link', 'lbprojects') . '</label>';			
			$output .= '<input id="' . esc_attr( $value['id'] ) . '_link' . '" class="of-input" name="' . esc_attr( $option_name . '[' . $value['id'] . '][link]' ) . '" type="text" value="' . esc_attr( $val['link'] ) . '" />';			
			...
			$output .= '<label class="explain" for="' . esc_attr( $value['id'] . '_text' ) . '">' . __('Text', 'lbprojects') . '</label>';
			$output .= '<textarea id="' . esc_attr( $value['id'] . '_text' ) . '" class="of-input" name="' . esc_attr( $option_name . '[' . $value['id'] . '][text]' ) . '" rows="' . $rows . '">' . esc_textarea( $val['text'] ) . '</textarea>';	
			$output .= '</div>';
		...
		if ( ( $value['type'] != "heading" ) && ( $value['type'] != "info" ) ) {
			$output .= '</div>';
			if ( ( $value['type'] != "checkbox" ) && ( $value['type'] != "editor" ) && ( $value['type'] != "slider" ) ) {
				$output .= '<div class="explain">' . wp_kses( $explain_value, $allowedtags) . '</div>'."\n";
			}
			$output .= '</div></div>'."\n";
		}
