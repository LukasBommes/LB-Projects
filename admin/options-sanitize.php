...
function of_sanitize_slider( $input ) {
	...
	$output['image'] = apply_filters( 'of_sanitize_upload', $input['image'] );
	$output['title'] = apply_filters( 'of_sanitize_text', $input['title'] );
	$output['link'] = apply_filters( 'of_sanitize_text', $input['link'] );
	$output['text'] = apply_filters( 'of_sanitize_textarea', $input['text'] );
...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __('No Repeat', 'lbprojects'),
		'repeat-x'  => __('Repeat Horizontally', 'lbprojects'),
		'repeat-y'  => __('Repeat Vertically', 'lbprojects'),
		'repeat'    => __('Repeat All', 'lbprojects'),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __('Top Left', 'lbprojects'),
		'top center'    => __('Top Center', 'lbprojects'),
		'top right'     => __('Top Right', 'lbprojects'),
		'center left'   => __('Middle Left', 'lbprojects'),
		'center center' => __('Middle Center', 'lbprojects'),
		'center right'  => __('Middle Right', 'lbprojects'),
		'bottom left'   => __('Bottom Left', 'lbprojects'),
		'bottom center' => __('Bottom Center', 'lbprojects'),
		'bottom right'  => __('Bottom Right', 'lbprojects')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __('Scroll Normally', 'lbprojects'),
		'fixed'  => __('Fixed in Place', 'lbprojects')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __('Normal', 'lbprojects'),
		'italic'      => __('Italic', 'lbprojects'),
		'bold'        => __('Bold', 'lbprojects'),
		'bold italic' => __('Bold Italic', 'lbprojects')
		);
	return apply_filters( 'of_recognized_font_styles', $default );
}

// Check iv given string is hexadecimally formatted color
