...
function LB_style_options() {
	echo '<style type="text/css">';
		...
		.'a.button, a.button:active, a.button:visited { background-color:' . of_get_option('link_color') . ';}'
		...
		.'.article .article-comments:hover span { border-top: 6px solid' . of_get_option('link_color') . ' !important;}'
